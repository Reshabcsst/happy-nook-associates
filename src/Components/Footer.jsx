            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col">
                        ...
                        <p><Call sx={{ fontSize: '20px' }} /> +91 98360-75849</p>
                        <p><Mail sx={{ fontSize: '20px' }} /> ashisnaskar379@happynookassociates.com</p>
                        <p className='address'><LocationCity sx={{ fontSize: '20px' }} />11, Latoo Babu Lane. Kolkata-700006 (Opp. Beadon Street Post Office)</p>
                    </div>
                    <div className="col">
                        <h3>Social Media</h3>
                        <div className="social-icons">
                            <a target="_blank" rel="noreferrer" aria-label="facebook" href="https://www.facebook.com/share/HBqbZKLFhBunMQUH/"><FaFacebookF /></a>
                            ...
                            <a target="_blank" rel="noreferrer" aria-label="linkedin" href="https://www.linkedin.com/in/happy-nook-associates-85349254"><FaLinkedinIn /></a>
                        </div>
                    </div>
                </div>
